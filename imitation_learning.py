...
class Agent:
    ...
    def get_sample_actions(self,states, unit_masks):
        ...
        for i in range(self.num_envs):
            ...
            imitation_actions[i] = action.action_to_one_hot(width, height)
...
class Calculator:
    ...
    def train(self, states, teacher_actions):
        ...
        loss = F.kl_div(net_action_dist, teacher_actions, reduction='batchmean')
...
class Calculator:
    ...
    def train(self, states, teacher_actions):
        ...
        teacher_actions = teacher_actions.to(device).float()
        loss = F.kl_div(net_action_dist.log(), teacher_actions, reduction='batchmean')
        self.share_optim.zero_grad()
        loss.backward()
...
if __name__ == "__main__":
    ...
    for version in range(MAX_VERSION):
        ...
        for _ in range(REPEAT_TIMES):
            calculator.train(states, teacher_actions)
>>>>>>> d60187a35ee0077ed8cc7484404529a8649924bb
